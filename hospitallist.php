...
if(isset($_POST['signin'])) {
  ...
  if ($result) {
echo "<script>window.location.href='hospitallist.php'</script>";
  }
  else{
...
<head>
  ...
  <title>Pandemic Aid | Hospital</title>
  ...
  <main id="main">
    ...
    <section id="blog" class="blog">
      ...
      <?php foreach($result as $row): ?>    
        <div class="bed">
          <div class="bname">
            <h3><strong><?php echo $row['hname']; ?></strong>
          ...
          <p class="float-left">Total Beds: <?php echo $row['nbed']; ?></p>
          </div>
          <div class='kj'>
          ...
          <?php if(!(isset($_SESSION['login']))){?>
                   ...
                   <?php  } else{ ?>
            <a href="hospitalabout.php?id=<?php echo $row['id'];?>" class="btn btn-primary">Read More</a>
            <?php }?>
