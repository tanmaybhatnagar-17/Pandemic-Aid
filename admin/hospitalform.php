...
<div class="col-lg-6 ">
            <form action="" method="post" class="" enctype="multipart/form-data" >
              <div class="row gy-4">
                ...
                <div class="col-md-12">
                  <p>Hospital Name</p>
                  <input type="text" name="hname" class="form-control" placeholder="Enter your Hospital name" required>
                </div>
                ...
                <div class="col-md-12">
                  <p>Phone Number</p>
                  <input type="text" name="mob" class="form-control" placeholder="Enter your Mobile Number" required>
                </div>
                ...
                <textarea class="form-control" name="about" rows="4" placeholder="Enter About the Hospital" required></textarea>
                </div>

                <div class="col-md-12 mt-4">
                <p>Total number of Beds</p>  
                <input type="text" class="form-control" name="nbed" placeholder="Number of beds" required></textarea>
                </div>
