...
$results=$c->adddoc($doctorname,$email,$mobno,$gender,$npi,$des,$category,$image,$password);
 if ($results){
...
<div class="col-lg-6 ">
            <form action="" method="post" class="" enctype="multipart/form-data" >
              <div class="row gy-4">
                ...
                <div class="col-md-12">
                  <p>Name</p>
                  <input type="text" name="fname" class="form-control" value="<?php echo $ers['name']; ?>" required>
                </div>
                ...
                <div class="col-md-12">
                  <p>Phone Number</p>
                  <input type="text" name="mob" maxlength="11" class="form-control" value="<?php echo
                  $ers['mob']; ?>" required>
                </div>

                <div class="col-md-6 mt-4 form-check">
                    <p>Gender</p>
                    <input type="radio" name="r1" id="male" value="Male" <?php if ($ers['gender']=='Male') echo "checked"; ?>
>
                    <label class="form-check-label col-lg-4" for="exampleRadios1">
                        &nbspMale
                    </label>
                    
                    <input type="radio" name="r1" id="female" value="Female" <?php if ($ers['gender']=='Female') echo "checked"; ?>>
                ...
                <p>Bio</p>  
                <textarea class="form-control" name="bio" rows="6" value="" required><?php echo $ers['description']; ?></textarea>
                </div>
                ...
                <div class="col-md-12 mt-4">
                  <p>Your picture</p>
                  <div class="kjroks">
                    <img  src="../uploads/doctor/<?php echo $ers['image']; ?>" required>
                 </div>  
                </div>
                <div class="col-md-12 mt-4">
                ...
                <div class="col-md-12 mt-4">
                  <p>Password</p>
                  <input type="text" name="pass" class="form-control" value="<?php echo $ers['password']; ?>" required>
                </div>
